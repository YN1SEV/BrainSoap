...
document.getElementById("best-streak").textContent       = `Temp`;
document.getElementById("sites-blocked").textContent     = `Temp`;
document.getElementById("active-days").textContent       = `Temp`;